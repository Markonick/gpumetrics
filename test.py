    ...
    try:
        ...
        while True:
            ...
            for i in range(device_count):
                ...
                print hostname
                print core.REGISTRY
                #push_to_gateway('192.168.0.6:9091', job=hostname, registry=core.REGISTRY)
                push_to_gateway(host_ip + ':' + port, job=hostname, registry=core.REGISTRY)
